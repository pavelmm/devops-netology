...
![grafana](https://github.com/pavelmm/devops-netology/blob/main/screen/10_3_1.png) </br>
...
![grafana](https://github.com/pavelmm/devops-netology/blob/main/screen/10_3_2.png) </br>
...
Ответ
<details><summary>Полученное оповещение:</summary>
![grafana](https://github.com/pavelmm/devops-netology/blob/main/screen/10_3_send1.png) </br>
![grafana](https://github.com/pavelmm/devops-netology/blob/main/screen/10_3_send2.png) </br>
 ...
 
 {
  ...
  "panels": [
    ...
    },
    {
      ...
      "description": "filesystem_free_bytes",
      "fieldConfig": {
        "defaults": {
          "color": {
  ...
  "time": {
    "from": "2022-10-30T10:45:07.850Z",
    "to": "2022-10-30T17:33:07.850Z"
  },
  "timepicker": {
    "refresh_intervals": [
      "5s",
