...
Uptime:                 17 hours 37 min 40 sec

Threads: 2  Questions: 5  Slow queries: 0  Opens: 17  Open tables: 10  Queries per second avg: 0.000
--------------
```

```
[root@localhost docker]# docker pull mysql:8.0
8.0: Pulling from library/mysql
Digest: sha256:b1cc887ed32cc6c2f217b12703bd05f503f2037892c8bb226047fe5dff85a109
Status: Downloaded newer image for mysql:8.0
docker.io/library/mysql:8.0
[root@localhost docker]# docker volume create vol_mysql
vol_mysql
[root@localhost docker]# docker run --rm --name mysql-docker -e MYSQL_ROOT_PASSWORD=mysql -ti -p 3306:3306 -v vol_mysql:/etc/mysql/ mysql:8.0
...
